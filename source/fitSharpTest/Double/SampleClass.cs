...
namespace fitSharp.Test.Double {
    public class SampleClass {
        ...
        public string OverloadMethod(string input) {
            return "sample1" + input;
        }

        public string OverloadMethod(int input) {
            return "sample2" + input;
        }
    ...
    public static class SampleExtension {
        public static int Increase(this SampleClass sample, int amount) {
            return sample.CountBy(amount);
        }
    }
}