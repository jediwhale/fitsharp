...
namespace fitSharp.Slim.Service {
    public class SlimOperators: Operators<string, Processor<string>>, Copyable {
        ...
        public SlimOperators() {
            ...
            Add(new ParseType<string, Processor<string>>(), 0);
            Add(new ParseList(), 0);
        ...
        public SlimOperators(Operators<string, Processor<string>> other): this() {
            Copy(other);
        }
