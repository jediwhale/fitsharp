...
namespace fitSharp.Fit.Operators {
    public class CompareNumeric : CellOperator, CompareOperator<Cell> {
        ...
        static readonly Comparison[] comparisons = {
        ...
        public bool Compare(TypedValue actual, Tree<Cell> expected) {
            ...
            expected.Value.SetAttribute(CellAttribute.InformationPrefix, actualValue.ToString());
        ...
        static Comparison FindComparison(string theExpectedValue) {
