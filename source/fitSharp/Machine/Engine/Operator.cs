...
namespace fitSharp.Machine.Engine {
    ...
    public interface FindMemberOperator<T> {
        bool CanFindMember(TypedValue instance, MemberQuery query);
        TypedValue FindMember(TypedValue instance, MemberQuery query);
    }
}
