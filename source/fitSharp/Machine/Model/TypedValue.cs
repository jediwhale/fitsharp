...
namespace fitSharp.Machine.Model {
    public readonly struct TypedValue {
        ...
        public static TypedValue Of(object instance) { return new TypedValue(instance); }
        ...
        public bool IsVoid => Type == typeof (void) && Value == null;
        public bool IsInvalid => Type == typeof (void) && Value != null;
        public bool IsValid => !IsInvalid;
        public bool IsObject => IsValid && ! IsVoid;
        public bool HasValue => IsObject && !IsNull;
        public bool HasValueAs<T>() { return HasValue && Value is T; }
        public bool IsNull => IsObject && (Value == null || Type == typeof(DBNull));
        public bool IsNullOrEmpty => IsObject && (IsNull || Value.ToString().Length == 0);
