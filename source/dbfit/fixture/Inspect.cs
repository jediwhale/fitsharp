...
namespace dbfit.fixture
{
    public class Inspect:fit.Fixture
    {
        ...
        private void addRows(Parse table)
        {
            var query = "SELECT * FROM " + this.objectName;
            this.InspectQuery(table, query);
        }
        ...
        private void InspectQuery(Parse table, string query)
        {
        ...
        {
            this.InspectQuery(table, this.objectName);
        }
        ...
        private Parse getDataRow(DataRow rs)
        {
            ...
            {
                Object value = GetValue(rs, rs.Table.Columns[i]);
        ...
        private static object GetValue(DataRow dr, DataColumn column)
        {
