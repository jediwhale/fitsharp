...
namespace fit.Test.NUnit {
    [TestFixture] public class HtmlParserTest {
        ...
        [Test] public void ParseEmpty() {
            Parse result = Parse.ParseFrom(string.Empty);
            Assert.IsTrue(result == null);
        }
    
        [Test] public void ParseNoTables() {
            Parse result = Parse.ParseFrom("set the table");
            Assert.IsTrue(result == null);
            result = Parse.ParseFrom("set the <table");
            Assert.IsTrue(result == null);
        }
    
        [Test, ExpectedException(typeof(ApplicationException))] public void ParseEmptyTable() {
            Parse.ParseFrom("leader<table x=\"y\"></table>trailer");
        }
    
        [Test, ExpectedException(typeof(ApplicationException))] public void ParseTableWithBody() {
            Parse.ParseFrom("leader<Table foo=2>body</table>trailer");
        }
    
        [Test] public void ParseTwoTables() {
            string result = Format(Parse.ParseFrom("<table><tr><td>x</td></tr></table>leader<table><tr><td>x</td></tr></table>trailer"), " ");
        ...
        [Test, ExpectedException(typeof(ApplicationException))] public void ParseRow() {
            Parse.ParseFrom("<table>leader<tr></tr></table>");
        }
    
        [Test] public void ParseCell() {
            string result = Format(Parse.ParseFrom("<table x=\"y\"><tr><td>content</td></tr></table>"), " ");
            Assert.AreEqual("<table x=\"y\"> <tr> <td> content</td></tr></table>", result);
        }
    
        [Test] public void ParseRowWithCellAndBody() {
            string result = Format(Parse.ParseFrom("<table><tr><td>content</td>somebody</tr></table>"), " ");
            Assert.AreEqual("<table> <tr> <td> content</td> somebody</tr></table>", result);
        }
    
        [Test] public void ParseCellMixedCase() {
            string result = Format(Parse.ParseFrom("leader<table><TR><Td>body</tD></TR></table>trailer"), " ");
            Assert.AreEqual("leader <table> <TR> <Td> body</tD></TR></table> trailer", result);
        }
    
        [Test] public void ParseNestedTable() {
            string result = Format(Parse.ParseFrom("<table><tr><td><table><tr><td>content</td></tr></table></td></tr></table>"), " ");
            Assert.AreEqual("<table> <tr> <td> <table> <tr> <td> content</td></tr></table></td></tr></table>", result);
        }
    
        [Test] public void ParseTwoNestedTables() {
            string result = Format(Parse.ParseFrom("<table><tr><td><table><tr><td>content</td></tr></table><table><tr><td>content</td></tr></table></td></tr></table>"), " ");
        ...
        [Test] public void ParseNestedTableAndBody() {
            string result = Format(Parse.ParseFrom("<table><tr><td><table><tr><td>content</td></tr></table>somebody</td></tr></table>"), " ");
        ...
        [Test] public void ParseNestedTableAndSplitBody() {
            string result = Format(Parse.ParseFrom("<table><tr><td>some<table><tr><td>content</td></tr></table>body</td></tr></table>"), " ");
            Assert.AreEqual("<table> <tr> <td> some <table> <tr> <td> content</td></tr></table> body</td></tr></table>", result);
        }
    
        [Test] public void ParseNestedList() {
            string result = Format(Parse.ParseFrom("<table><tr><td><ul><li>content</li></ul></td></tr></table>"), " ");
            Assert.AreEqual("<table> <tr> <td> <ul> <li> content</li></ul></td></tr></table>", result);
        }
    
        [Test] public void ParseNestedListAndTable() {
            string result = Format(Parse.ParseFrom("<table><tr><td><ul><li>content</li></ul><table><tr><td>content</td></tr></table></td></tr></table>"), " ");
