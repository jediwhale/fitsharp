// Copyright © 2025 Syterra Software Inc. Includes work by Object Mentor, Inc., © 2002 Cunningham & Cunningham, Inc.
...
namespace fit.Test.NUnit {
    [TestFixture] public class CellMaking {
        [Test] public void CellIsMadeWithSimpleString() {
            ...
            ClassicAssert.AreEqual("<td><span class=\"fit_grey\">something</span></td>", cell.ToString());
        }

        [Test] public void CellIsMadeWithArray() {
            var service = new Service.Service();
            var cell = (Parse) service.Compose(new [] {"something", "else"});
            ClassicAssert.AreEqual("<td><span class=\"fit_grey\">something, else</span></td>", cell.ToString());
        }
