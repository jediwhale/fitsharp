...
namespace fit.Operators {
    public class ComposeStoryTestString: CellOperator, ComposeOperator<Cell> {
        ...
        public Tree<Cell> Compose(TypedValue instance) {
            ...
            return storyTestInput.Contains(Characters.TextStoryTestBegin)
                ? new ComposeTextStoryTestString {Processor = Processor}.Compose(instance)
                : new ComposeHtmlStoryTestString {Processor = Processor}.Compose(instance);
        }
    }
}
